...
import { ArrowLeft, BadgeCheck, Check, Megaphone } from "lucide-react";
...
function AdvertisePage() {
  ...
  if (submitted)
    return (
      <main className="grid min-h-screen place-items-center bg-background p-6">
        <div className="max-w-lg rounded-3xl border border-border bg-card p-10 text-center premium-shadow">
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-brand-soft text-brand">
            <BadgeCheck className="size-7" />
          </span>
          <h1 className="mt-5 text-3xl font-extrabold">Campaign received.</h1>
          <p className="mt-3 text-muted-foreground">
            Our team will verify your AI tool and contact you with manual payment details before
            anything goes live.
          </p>
  ...
  return (
    <main className="min-h-screen bg-background/90 p-4 sm:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <section className="rounded-3xl bg-primary p-8 text-primary-foreground sm:p-10">
            ...
            <p className="mt-8 text-xs font-bold uppercase tracking-[0.18em] text-primary-foreground/55">
            ...
            <div className="mt-10 space-y-4">
              {[
                ...
                <div key={item} className="flex items-center gap-3 text-sm">
                  <span className="grid size-6 place-items-center rounded-full bg-brand text-primary-foreground">
          ...
          <form
            ...
            className="rounded-3xl border border-border bg-card p-6 premium-shadow sm:p-10"
          >
            <h2 className="text-2xl font-extrabold">Create your campaign</h2>
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  required
                  rows={4}
                  className="w-full rounded-xl border border-input bg-background px-4 py-3 text-sm outline-none focus:border-brand focus:ring-4 focus:ring-brand-soft"
                />
              </div>
            ...
            <fieldset className="mt-6">
              ...
              <div className="grid gap-2 sm:grid-cols-3">
                {["Sidebar", "Featured AI", "Homepage"].map((p) => (
                  ...
                  >
                    <input required type="radio" name="placement" className="accent-current" />
                    {p}
                  </label>
                ))}
              </div>
  ...
  return (
    <label className="block">
      ...
      <input
        type={type}
        required={required}
        className="h-11 w-full rounded-xl border border-input bg-background px-4 text-sm outline-none focus:border-brand focus:ring-4 focus:ring-brand-soft"
      />
    </label>
  );
}
