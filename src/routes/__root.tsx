...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient; auth: { user: User | null } }>()({
  head: () => ({
    meta: [
      ...
      { title: "MarkBook — Discover 51,000+ AI Tools | Best AI Tools Directory 2025" },
      {
        name: "description",
        content:
          "MarkBook is the largest AI tools directory with 51,000+ AI tools across 497+ categories. Compare AI chatbots, image generators, video generators, code assistants, writing tools, and more. Free and paid options. Updated daily.",
      },
      {
        name: "keywords",
        content:
      ...
      { property: "og:title", content: "MarkBook — Discover 51,000+ AI Tools | Best AI Tools Directory" },
      { property: "og:description", content: "The largest AI tools directory with 51,000+ tools. Compare AI chatbots, image generators, video tools, code assistants, and more. Updated daily." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "MarkBook AI" },
      { property: "og:url", content: "https://markbookai.com" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MarkBook — Discover 51,000+ AI Tools | Best AI Directory 2025" },
      { name: "twitter:description", content: "The largest AI tools directory with 51,000+ tools. Compare AI chatbots, image generators, video tools, code assistants, and more." },
    ...
    scripts: [
      {
        ...
        innerHTML: JSON.stringify({
          ...
          "description": "The largest AI tools directory with 51,000+ AI tools across 497+ categories.",
          "potentialAction": {
            "@type": "SearchAction",
      ...
      },
      {
        ...
        innerHTML: JSON.stringify({
          ...
          "description": "A comprehensive directory of 51,000+ AI tools spanning 497+ categories, including pricing, descriptions, categories, and direct links.",
