...
<div class="c">
  ...
  <div class="cta"><h2>Explore 56,000+ AI Tools</h2><p>Discover the full MarkBook AI tools directory</p><a href="/">Browse All AI Tools &rarr;</a></div>
</div>
<script>
(function(){
  ...
  function loadMore(){
    ...
    LOADING=true;
    loader.textContent='Loading '+(Math.min(60,TOTAL-OFFSET))+' more tools... ('+grid.children.length.toLocaleString()+' / '+TOTAL.toLocaleString()+')';
